...
export default function Navbar() {
  return (
    <nav className="absolute top-0 flex w-screen py-4 px-6 items-center justify-between z-50 bg-black/70 text-white/80">
      <div className="relative h-20 aspect-[53/13]">
